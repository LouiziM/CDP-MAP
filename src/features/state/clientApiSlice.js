...
export const clientApiSlice = apiSlice.injectEndpoints({
  endpoints: builder => ({
    ...
    getCustomerMarketingCampaigns: builder.query({
      query: (id) => ({
        url: `/clients/marketing-campaigns/${id}`,
        method: 'GET',
      }),
...
export const { useGetCustomerMarketingCampaignsQuery,useGetSatisfactionQuery ,useGetAllClientsQuery, useGetCompletionQuery, useGetCustomersPerRegionQuery, useGetParcClientsQuery, useGetPassageSAVQuery } = clientApiSlice;
